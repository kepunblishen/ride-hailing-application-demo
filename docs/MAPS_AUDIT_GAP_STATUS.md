...
**Companions:** [`GOOGLE_MAPS_SETUP.md`](GOOGLE_MAPS_SETUP.md) Â· [`GOOGLE_API_MATRIX.md`](GOOGLE_API_MATRIX.md) Â· [`GOOGLE_MAPS_ARCHITECTURE.md`](GOOGLE_MAPS_ARCHITECTURE.md) Â· [`GOOGLE_INTEGRATION_TEST_PLAN.md`](GOOGLE_INTEGRATION_TEST_PLAN.md) Â· [`MAPS_CAPABILITY_MATRIX.md`](MAPS_CAPABILITY_MATRIX.md) Â· [`MAPS_HARDENING_FINAL_REPORT.md`](MAPS_HARDENING_FINAL_REPORT.md) Â· [`PLACES_SDK_DECISION.md`](PLACES_SDK_DECISION.md) Â· [`PRE_BUILD_MAPS_GATE.md`](PRE_BUILD_MAPS_GATE.md) Â· [`MAPS_POST_KEY_QA.md`](MAPS_POST_KEY_QA.md) Â· [`DEVICE_QA_EVIDENCE.md`](DEVICE_QA_EVIDENCE.md) Â· [`CODEMAGIC_SETUP.md`](CODEMAGIC_SETUP.md)
...
Legend: `[x]` done Â· `[~]` partial Â· `[ ]` unfinished
...
| 3 | SPM / no CocoaPods | [x] | `ios-maps-sdk` â‰¥ 10.0.0 (`upToNextMajor`) product `GoogleMaps`; no Podfile |
...
| 11 | Place field masking | [x] | Details `id,displayName,formattedAddress,location`; autocomplete prediction field mask |
...
| 15 | Reverse geocoding | [x] | Google when keyed -> CLGeocoder -> coords; throttle 45 m / 18 s; naming hardened (ReverseGeocodingNamingTests) |
| 16 | Caching | [x] | `MapsRequestCache` (routes/geocode TTL) + place `BoundedTTLCache`; reverse-geocode throttle |
...
| 22 | Concurrency | [x] | Query generation / task cancel in `PlacesSearchController`; route builds via session lifecycle |
...
| 44 | Geocoding | [x] | Google reverse when keyed + CLGeocoder fallback; Current location naming hardened; forward geocode unused |
...
| 64â€“68 | RFQ / trust / corp / sales / discovery | [x] | Cross-covered by product directive + gap trackers; not Maps-blocking |
| 69 | Uber / Bolt capability matrix | [x] | [`MAPS_CAPABILITY_MATRIX.md`](MAPS_CAPABILITY_MATRIX.md) |
| 70 | Final Google Cloud recommendation | [x] | [`GOOGLE_API_MATRIX.md`](GOOGLE_API_MATRIX.md) recommends key set; **Console apply** still operator (Â§5) |
...
| 76 | Final product standard | [~] | Software bar met for presentation build; live Maps bar = Â§77 device |
| 77 | Final acceptance test | [ ] | **Device + keyed IPA** |
| 78 | Final report Aâ€“T | [x] | [`MAPS_HARDENING_FINAL_REPORT.md`](MAPS_HARDENING_FINAL_REPORT.md) - honest; Cloud/device acceptance still open in Â§T |
...
**Focus:** maps unavailable Â· invalid key Â· network fail Â· placeholderâ†”live Â· no demo language  
**Date:** 2026-08-23 Â· **Snyk:** not used Â· **Commit:** none
...
| No demo / â€œAdd API keyâ€ in UI | [x] | `L10n` `map.unavailable_title` / `map.unavailable_detail` |
| Placeholder â†” live switch | [x] | `MapBootstrap.surface` / `isConfigured` at `makeUIView`; live after key + relaunch |
...
| Central â€œUnable to... / Retryâ€ for routes | [ ] | Gap Â§17â€“Â§18 residual |
